...
console.log(color('🐶 WA NUMBER: +233595885532 ','silver'))
console.log(color('  🦄TIMTECH. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/233595885532'))
    console.log(color('🐶', 'cyan'), color('VIRTUAL KOMBAT IS ONLINE...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using Virtual Kombat', 'white'))
